...
#a=load(os.path.join(otxt_hardpath,'H4','H4_liver.txt'), c=(255,99,71), alpha=1)
# b=load(os.path.join(otxt_hardpath,'H4','H4_skin.txt'), c=(255,20,147), alpha=0.5)

helper= np.loadtxt(os.path.join(otxt_hardpath,'H4','H4_liver.txt'))
